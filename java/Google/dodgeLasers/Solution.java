 ...
 * =================
 * 
 * Oh no! You've managed to escape Commander Lambda's collapsing space station
 * in an escape pod with the rescued bunny workers - but Commander Lambda isnt
 * about to let you get away that easily. Lambda sent an elite fighter pilot
 ...
 * returns the sum of (floor(1*sqrt(2)) + floor(2*sqrt(2)) + ... +
 * floor(n*sqrt(2))) as a string. That is, for every number i in the range 1 to
 * n, it adds up all of the integer portions of i*sqrt(2).
 * 
 ...
 * solution passes the test cases, it will be removed from your home folde
 * 
 * https://vitaminac.github.io/Google-Foobar-Dodge-The-Lasers/
 */
class Solution {
    private static final BigInteger TWO = BigInteger.valueOf(2);
    private static final BigDecimal FACTOR = new BigDecimal(
